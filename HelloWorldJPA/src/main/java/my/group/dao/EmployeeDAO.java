...
public class EmployeeDAO implements IEmployeeDAO {
	...
	public void delete(Employee entity) {
		...
		try {
			entity = getEntityManager().getReference(Employee.class,
	...
	public Employee findById(Integer id) {
		EntityManagerHelper.log("finding Employee instance with id: " + id,
				Level.INFO, null);
		try {
	...
	public List<Employee> findByProperty(String propertyName, final Object value) {
		EntityManagerHelper.log("finding Employee instance with property: "
	...
	public List<Employee> findAll() {
		EntityManagerHelper.log("finding all Employee instances", Level.INFO,
				null);
		try {
