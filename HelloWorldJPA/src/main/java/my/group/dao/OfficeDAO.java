...
public class OfficeDAO implements IOfficeDAO {
	...
	public void delete(Office entity) {
		...
		try {
			entity = getEntityManager().getReference(Office.class,
	...
	public Office findById(String id) {
		EntityManagerHelper.log("finding Office instance with id: " + id,
				Level.INFO, null);
		try {
	...
	public List<Office> findByProperty(String propertyName, final Object value) {
		EntityManagerHelper.log("finding Office instance with property: "
	...
	public List<Office> findAll() {
		EntityManagerHelper.log("finding all Office instances", Level.INFO,
				null);
		try {
