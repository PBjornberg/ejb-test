...
public class OrderdetailDAO implements IOrderdetailDAO {
	...
	public void save(Orderdetail entity) {
		EntityManagerHelper
				.log("saving Orderdetail instance", Level.INFO, null);
		try {
	...
	public void delete(Orderdetail entity) {
		EntityManagerHelper.log("deleting Orderdetail instance", Level.INFO,
				null);
		try {
			entity = getEntityManager().getReference(Orderdetail.class,
					entity.getId());
	...
	public Orderdetail update(Orderdetail entity) {
		EntityManagerHelper.log("updating Orderdetail instance", Level.INFO,
				null);
		try {
	...
	public Orderdetail findById(OrderdetailId id) {
		EntityManagerHelper.log("finding Orderdetail instance with id: " + id,
				Level.INFO, null);
		try {
			Orderdetail instance = getEntityManager().find(Orderdetail.class,
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Orderdetail> findByProperty(String propertyName,
			final Object value) {
		EntityManagerHelper.log("finding Orderdetail instance with property: "
	...
	public List<Orderdetail> findAll() {
		EntityManagerHelper.log("finding all Orderdetail instances",
				Level.INFO, null);
		try {
