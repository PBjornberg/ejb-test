...
public class PurchaseorderDAO implements IPurchaseorderDAO {
	...
	public void save(Purchaseorder entity) {
		EntityManagerHelper.log("saving Purchaseorder instance", Level.INFO,
				null);
		try {
	...
	public void delete(Purchaseorder entity) {
		EntityManagerHelper.log("deleting Purchaseorder instance", Level.INFO,
				null);
		try {
			entity = getEntityManager().getReference(Purchaseorder.class,
	...
	public Purchaseorder update(Purchaseorder entity) {
		EntityManagerHelper.log("updating Purchaseorder instance", Level.INFO,
				null);
		try {
	...
	public Purchaseorder findById(Integer id) {
		EntityManagerHelper.log(
				"finding Purchaseorder instance with id: " + id, Level.INFO,
				null);
		try {
			Purchaseorder instance = getEntityManager().find(
	...
	public List<Purchaseorder> findByProperty(String propertyName,
			final Object value) {
		EntityManagerHelper.log(
				"finding Purchaseorder instance with property: " + propertyName
	...
	public List<Purchaseorder> findAll() {
		EntityManagerHelper.log("finding all Purchaseorder instances",
				Level.INFO, null);
		try {
