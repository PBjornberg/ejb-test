...
public class PaymentDAO implements IPaymentDAO {
	...
	public void delete(Payment entity) {
		...
		try {
			entity = getEntityManager().getReference(Payment.class,
					entity.getId());
	...
	public Payment findById(PaymentId id) {
		EntityManagerHelper.log("finding Payment instance with id: " + id,
				Level.INFO, null);
		try {
	...
	public List<Payment> findByProperty(String propertyName, final Object value) {
		EntityManagerHelper.log("finding Payment instance with property: "
	...
	public List<Payment> findAll() {
		EntityManagerHelper.log("finding all Payment instances", Level.INFO,
				null);
		try {
