 ...
 * element interface generated in the my.group.ws package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _MultiplyResponse_QNAME = new QName(
			"http://superbiz.org/wsdl", "multiplyResponse");
	private final static QName _SumResponse_QNAME = new QName(
			"http://superbiz.org/wsdl", "sumResponse");
	private final static QName _Sum_QNAME = new QName(
			"http://superbiz.org/wsdl", "sum");
	private final static QName _Multiply_QNAME = new QName(
			"http://superbiz.org/wsdl", "multiply");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: my.group.ws
	 * 
	 */
